...
argocd_bootstrap() {
  local ARGOCD_APP_FILE="$PROJECT_ROOT/apps/eu-central-1-dev/platform/argocd.yaml"
  ...
  local ARGOCD_VALUES="$PROJECT_ROOT/manifests/argocd/eu-central-1-dev/values.yaml"

  info "Bootstrapping ArgoCD..."
